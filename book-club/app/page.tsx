        ...
        <div className="flex justify-center items-center">
          <div className="group relative">
            <div className=" flex relative justify-center mt-50 w-2xl h-125 shadow-md bg-sky-900">
              ...
              <div className={`bg-sky-900 opacity-70 w-full h-80 bg-gradient-to-b from-sky-800 to-sky-900 origin-top transition-transform duration-500 [clip-path:polygon(0_0,100%_0,50%_100%)] ${envelope ? `-scale-y-100 opacity-100` : `scale-y-100`}`}>
              </div>
              <div className={`absolute flex items-center z-0 justify-center rounded-full opacity-85 bg-cyan-700 w-20 h-20  translate-y-9/3 transition-transform duration-500 ${envelope ? '-translate-y-20' : 'rotate-0'}`}>
              ...
              <div className={`bg-white -translate-y-2/3 text-black font-mono translate-x-1/12 w-xl transition-transform duration-500 h-100 ${envelope ? `opacity-100 -translate-y-[90%]` : `opacity-0 -translate-y-2/3` }`}>
              <h1>Dear {username}, </h1>
              <br></br>
